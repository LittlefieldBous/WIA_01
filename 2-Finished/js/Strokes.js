window.onload = function() {
	...
	//miter is a #
	//could be round, butt or square
	//miter looks pointy
	//bevel makes it look like a square end.
	shape.graphics.setStrokeStyle(10, "miter", 5);
	...
	shape.graphics.bezierCurveTo(100, 50, 100, 600, 250, 250);
